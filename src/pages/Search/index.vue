      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-for="(prop,index) in option.props" :key="prop">{{prop}}<i
                @click="removePorp(index)">×</i></li>
          </ul>
        </div>
        ...
        <div class="details">
          ...
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
            :current-page.sync="currentPage" :page-sizes="[2, 10, 20, 50]" :page-size="list.pageSize"
